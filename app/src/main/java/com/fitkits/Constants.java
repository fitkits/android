...
public class Constants {
    ...
    public static void internetToast(Context context){
        Toast.makeText(context,"No internet avaialble. Try again later.",Toast.LENGTH_SHORT).show();
    }
    public static void internetToastButLogged(Context context){
        Toast.makeText(context,"No internet avaialble. Your data might be logged tonight.",Toast.LENGTH_SHORT).show();
    }
