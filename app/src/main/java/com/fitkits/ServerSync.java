...
import com.fitkits.Answers.LogWeightDialog.InterfaceCommunicator;
    ...
    apiService.logWeight(weightAnswer)
        ...
        new Observer<ResponseBody>() {
          ...
          public void onNext(ResponseBody value) {
            ...
            NotificationScheduler.showNotification(getApplicationContext(), HomeActivity.class,"Daily Weight", "Your data has been logged successfully", 0,"All");
          ...
          public void onError(Throwable e) {
            NotificationScheduler.showNotification(getApplicationContext(), HomeActivity.class,"Error Syncing", "Couldn't push data to server", 0,"All");
    ...
    apiService.logWater(waterAnswer)
        ...
        new Observer<ResponseBody>() {
          ...
          public void onNext(ResponseBody value) {
            ...
            realmUI.commitTransaction();
            NotificationScheduler.showNotification(getApplicationContext(), HomeActivity.class,"Daily Water Consumption", "Your data has been logged successfully", 0,"All");
    ...
    apiService.logSleep(sleepAnswer)
        ...
        new Observer<ResponseBody>() {
          ...
          public void onNext(ResponseBody value) {
            ...
            realmUI.commitTransaction();
            NotificationScheduler.showNotification(getApplicationContext(), HomeActivity.class,"Daily Sleep Hours", "Your data has been logged successfully", 0,"All");
    ...
    apiService.logCalorie(calorieAnswer)
        ...
        new Observer<ResponseBody>() {
          ...
          public void onNext(ResponseBody value) {
            ...
            realmUI.commitTransaction();
            NotificationScheduler.showNotification(getApplicationContext(), HomeActivity.class,"Daily Calorie intake", "Your data has been logged successfully", 0,"All");
    ...
    apiService.logActivity(activityAnswer)
        ...
        new Observer<ResponseBody>() {
          ...
          public void onNext(ResponseBody value) {
            ...
            NotificationScheduler.showNotification(getApplicationContext(), HomeActivity.class,"Daily Active Hours", "Your data has been logged successfully", 0,"All");
