package com.fitkits.Subscriptions;
...
public class SubscriptionActivity extends AppCompatActivity implements PaymentResultListener, MembershipAdapter.InterfaceCommunicator, PendingInterface {
                ...
                new Observer<ItemParent>() {
                    ...
                    public void onNext(ItemParent value) {
                        ...
                        if (membershipItemList.size() > 0) {
                            membershipRecyclerView.setAdapter(new MembershipAdapter(SubscriptionActivity.this, getSupportFragmentManager(), SubscriptionActivity.this, membershipItemList));
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(SubscriptionActivity.this, R.string.TOAST_DEFAULT_ERROR_MESSAGE, Toast.LENGTH_LONG).show();
  ...
  client.newCall(request).enqueue(new Callback() {
    ...
    public void onFailure(Call call, IOException e) {
      Toast.makeText(SubscriptionActivity.this,R.string.TOAST_DEFAULT_ERROR_MESSAGE,Toast.LENGTH_SHORT).show();
