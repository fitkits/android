package com.fitkits.Goals.Adapters;
...
if(position==0) {
    ...
    if (userMasterGoal.getGoals().getCaloriesPerDay().getValue() == 0) {
        ...
        holder.goalText.setText(R.string.TXT_GOAL_CALORIE_TEXT);
        holder.goalDesc.setText(R.string.TXT_GOAL_CALORIE_DESC);
    } else {
        holder.goalValLay.setVisibility(View.VISIBLE);
        holder.goalText.setText(R.string.TXT_DAILY_GOAL_CALORIES);
        holder.goalDesc.setText(R.string.TXT_CLICK_TO_EDIT);
    }
}
    ...
    if (userMasterGoal.getGoals().getActivePerDay().getValue() == 0) {
        holder.goalValLay.setVisibility(View.GONE);
        holder.goalText.setText(R.string.TXT_GOAL_ACTIVE_HOURS_TEXT);
        holder.goalDesc.setText(R.string.TXT_GOAL_ACTIVE_HOURS_DESC);
    } else {
        holder.goalValLay.setVisibility(View.VISIBLE);
        holder.goalText.setText(R.string.TXT_DAILY_ACTIVE_HOURS);
        holder.goalDesc.setText(R.string.TXT_CLICK_TO_EDIT);
    }
}
    ...
    if (userMasterGoal.getGoals().getWeight().getValue() == 0) {
        ...
        holder.goalValLay.setVisibility(View.VISIBLE);
        holder.goalText.setText(R.string.TXT_DAILY_GOAL_WEIGHT);
    ...
    if (userMasterGoal.getGoals().getSleepDurationPerDay().getValue() == 0) {
        holder.goalValLay.setVisibility(View.GONE);
        holder.goalText.setText(R.string.TXT_GOAL_SLEEP_TEXT);
        holder.goalDesc.setText(R.string.TXT_GOAL_SLEEP_DESC);
    } else {
        holder.goalValLay.setVisibility(View.VISIBLE);
        holder.goalText.setText(R.string.TXT_DAILY_GOAL_SLEEP);
        holder.goalDesc.setText(R.string.TXT_CLICK_TO_EDIT);
    }
}
else if(position==4) {
