...
import com.fitkits.RealmObjects.NumberOfCups;
...
public class Weight_Data extends RealmObject {
  ...
  public Weight_Data(CurrentWeight currentWeight, RecordedDate recordedDate, GoalWeight goalWeight, GoalDate goalDate){
  ...
  public Weight_Data(NumberOfCups numberOfCups){
