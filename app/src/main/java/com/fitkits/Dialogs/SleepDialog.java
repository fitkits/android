                    ...
                    if (wakeuptime.getText().toString().length() > 0) {
                        if (sleepgoal.getSelectedItemPosition() != 0) {
                            ...
                            Toast.makeText(getActivity(),
                                R.string.TOAST_SELECT_ACTIVE_HOURS, Toast.LENGTH_SHORT)
                                .show();
                        }
                    } else {
                        Toast.makeText(getActivity(), R.string.TOAST_SELECT_WAKEUP_TIME,
                            Toast.LENGTH_SHORT).show();

                    }

                } else {
                    Toast.makeText(getActivity(), R.string.TOAST_SELECT_BED_TIME, Toast.LENGTH_SHORT)
                        .show();
