            ...
            public void onClick(View view) {
                if(goalWeight.getText().toString().length()>0) {
                    if(goalWeightDate.getText().toString().length()>0) {
                        ...
                        Toast.makeText(getActivity(),R.string.TOAST_SELECT_DATE,Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    Toast.makeText(getActivity(),R.string.TOAST_SELECT_WEIGHT,Toast.LENGTH_SHORT).show();
                }
