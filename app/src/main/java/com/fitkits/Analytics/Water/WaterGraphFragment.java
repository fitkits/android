...
public class WaterGraphFragment extends Fragment {
  ...
  Bundle bundle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_line_graph, container, false);
        mChart = (LineChartView) layout.findViewById(R.id.chart);
        mChart.setBackground(getResources().getDrawable(R.drawable.gradient_chart_blue_bg));
        mFirstStage = true;
  ...
  void calcDates(){
    ...
    getWaterAggregateWeekly(startDate,endDate);
...
int i=3;
  ...
  List<Yearly> getNumberOfQuarters(int year, int month) {
    ...
    while ((c.get(Calendar.YEAR) == year)){
      ...
      quarters.add(new Yearly(startMonth+"-"+endMonth,0));
      c.add(Calendar.MONTH,+1);
                ...
                public void onNext(Aggregate value) {
                  ...
                  for(int i=0;i<value.getAggregate().getValue().size();i++){
                    ...
                    if(week==value.getAggregate().getValue().get(i).getWeek()+1){
                      ...
                      WaterGraphDetailActivity.average.setText(decimalFormat.format(value.getAggregate().getValue().get(i).getAverage()/250)+" glasses ");                    }
                  }
...
float sum=0;
                for(int i=0;i<weeksinMonth.size();i++){
                        try {
                          ...
                          DecimalFormat decimalFormat = new DecimalFormat("#.00");
                            mValuesOne[i]=Float.parseFloat(decimalFormat.format(weeksinMonth.get(i).getAverage()/250));
                    ...
                    if(sum>0.0f) {
                      ...
                      mChart.setXLabels(LabelPosition.OUTSIDE)
                          ...
                          .setValueThreshold((float)userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue()/250, (float)userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue()/250, thresPaint).setTooltips(mTip)
                          .show(new Animation().inSequence(.5f));
                      mChart.setAxisLabelsSpacing(50);
                      mChart.setStep(2);
                      mChart.setAxisBorderValues(0f,30);
                      mChart.setLabelsColor(Color.WHITE);
                      mChart.setGrid(15,0,axis);
        ...
        new Observer<Aggregate>() {
          ...
          public void onNext(Aggregate value) {
            ...
            for(int i=0;i<months.size();i++){
              ...
              DecimalFormat decimalFormat = new DecimalFormat("#.00");
              mValuesOne[i]=Float.parseFloat(decimalFormat.format(months.get(i).getAverage()/250));
            ...
            if(sum>0.0f) {
              ...
              mChart.setXLabels(LabelPosition.OUTSIDE)
                  ...
                  .setValueThreshold((float)userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue()/250,(float)userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue()/250, thresPaint).setTooltips(mTip)
                  .show(new Animation().inSequence(.5f));
              mChart.setAxisLabelsSpacing(30);
              mChart.setStep(2);
              mChart.setAxisBorderValues(0f,30);
              mChart.setLabelsColor(Color.WHITE);
              mChart.setGrid(15,0,axis);
        ...
        new Observer<Aggregate>() {
          ...
          public void onNext(Aggregate value) {
            ...
            for (int i = 0; i < quarters.size(); i++) {
              ...
              DecimalFormat decimalFormat = new DecimalFormat("#.00");
              mValuesOne[i]=Float.parseFloat(decimalFormat.format(quarters.get(i).getAverage()/250));
        ...
        new Observer<ItemParent>() {
          ...
          public void onNext(ItemParent itemParent) {
            ...
            for (int i = 0; i < datesList.size(); i++) {
              ...
              DecimalFormat decimalFormat = new DecimalFormat("#.00");
              mValuesOne[i]=Float.parseFloat(decimalFormat.format(datesList.get(i).getVal()/250));
            ...
            if (sum > 0.0f) {
              ...
              mChart.setXLabels(LabelPosition.OUTSIDE)
                  .setYLabels(LabelPosition.OUTSIDE)
                  .setValueThreshold(
                      (float) userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue()/250,
                      (float) userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue()/250,
