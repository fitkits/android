...
import com.fitkits.Analytics.Weight.WeightGraphFragment;
 ...
 * @since 1.0
 */
public class WaterGraphAdapter extends FragmentPagerAdapter {
    Bundle bundle;
    int length;
     ...
     */
    public WaterGraphAdapter(FragmentManager childFragmentManager) {
    ...
    public Fragment getItem(int position) {
        Fragment fragment=new WaterGraphFragment();
