...
import com.fitkits.Analytics.Sleep.SleepGraphFragment;
 ...
 * @since 1.0
 */
public class ActiveHoursGraphAdapter extends FragmentPagerAdapter {
    Bundle bundle;
    int length;
     ...
     */
    public ActiveHoursGraphAdapter(FragmentManager childFragmentManager) {
    ...
    public Fragment getItem(int position) {
        Fragment fragment=new ActiveHoursGraphFragment();
