...
public class ActiveHoursGraphActivity extends AppCompatActivity implements LogActiveDialog.InterfaceCommunicator,ActiveDialog.InterfaceCommunicator {
  ...
  public static ActiveHoursGraphActivity activityGraphActivity;

  CustomFixedHeightViewPager activeDataViewPager;
  TabLayout tabLayout;
  CardView logweight;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_activehours_graph);
    activityGraphActivity =this;
    myPrefs= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
    mChart = (StackBarChartView)findViewById(R.id.chart_bar);
    setGoal=(ImageView)findViewById(R.id.setGoal);
    activeDataViewPager =(CustomFixedHeightViewPager)findViewById(R.id.weightDataViewPager);
    target=(TextView)findViewById(R.id.target);
    tabLayout = (TabLayout)findViewById(R.id.tabs);
    tabLayout.setupWithViewPager(activeDataViewPager);
    ...
    viewMore.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {
        startActivity(new Intent(ActiveHoursGraphActivity.this,ActiveHoursGraphDetailActivity.class));
      }
    });
    logweight.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (activityAnswer != null||userMasterGoal==null) {
          ...
          logActiveDialog.show(getSupportFragmentManager(), "Activity");
        }
    ...
    setGoal.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        activeDialog.show(getSupportFragmentManager(), "Activity");
      }
    });
  ...
  void calcDates(int from){
    ...
    getActiveHoursAggregate(startDate,endDate,weeksinMonth,from);
        ...
        Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(
          new Observer<ItemParent>() {
            ...
            public void onSubscribe(Disposable d) {
              progressDialog = new ProgressDialog(ActiveHoursGraphActivity.this);
            ...
            public void onNext(ItemParent itemParent) {
              ...
              for (int i = 0; i < value.size(); i++) {
                ...
                if(value.get(i).getType().equals("activePerDay")) {
                  for(int j=0;j<value.size();j++) {
                    if (value.get(j).getType().equals("activePerDay")) {
                ...
                if (i == datesList.size() - 1) {
                  if (datesList.get(i).getVal() != 0) {
                    if (userMasterGoal.getGoals().getCaloriesPerDay().getValue()!=0) {
                      if (datesList.get(i).getVal() > userMasterGoal.getGoals().getActivePerDay().getValue()) {
                        float req = datesList.get(i).getVal() - userMasterGoal.getGoals().getActivePerDay().getValue();
                    ...
                    target.setText("Please log today's active hours.");
              ...
              if(sum>0.0f) {
                if (from == 0) {
                  ...
                  mChart.setXLabels(LabelPosition.TOP)
                      ...
                      .setValueThreshold(
                          (float) userMasterGoal.getGoals().getActivePerDay().getValue(),
                          (float) userMasterGoal.getGoals().getActivePerDay().getValue(),
              ...
              activeDataViewPager.setAdapter(new GoalDataViewPagerAdapter(getSupportFragmentManager(), datesList, weeksinMonth,"activePerDay"));
              activeDataViewPager.setOffscreenPageLimit(weeksinMonth.size());
            ...
            public void onError(Throwable e) {
              ...
              Toast.makeText(ActiveHoursGraphActivity.this,
