...
public class ActiveHoursGraphFragment extends Fragment {
  ...
  Bundle bundle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      pos=bundle.getInt("position");
        ...
        if(pos==2){
          getActiveHoursAggregateQuaterly();
  ...
  void calcDates(){
    ...
    getActiveHoursAggregateWeekly(startDate,endDate);
                ...
                public void onNext(Aggregate value) {
                  ...
                  for(int i=0;i<value.getAggregate().getValue().size();i++){
                    ...
                    if(week==value.getAggregate().getValue().get(i).getWeek()+1){
                      ActiveHoursGraphDetailActivity.average.setText(value.getAggregate().getValue().get(i).getAverage()+" hours");
                    }
                  }
                ...
                for(int i=0;i<weeksinMonth.size();i++){
                    ...
                    if(sum>0.0f) {
                      ...
                      mChart.setXLabels(LabelPosition.OUTSIDE)
                          ...
                          .setValueThreshold((float)userMasterGoal.getGoals().getActivePerDay().getValue(), (float)userMasterGoal.getGoals().getActivePerDay().getValue(), thresPaint).setTooltips(mTip)
          ...
          public void onNext(ItemParent itemParent) {
            ...
            if (sum > 0.0f) {
              ...
              mChart.setXLabels(LabelPosition.OUTSIDE)
                  .setYLabels(LabelPosition.OUTSIDE)
                  .setValueThreshold(
                      (float) userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue(),
                      (float) userMasterGoal.getGoals().getWaterConsumptionPerDay().getValue(),
