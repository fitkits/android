...
public class WeightGraphFragment extends Fragment {
  ...
  Bundle bundle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mChart.setBackground(getResources().getDrawable(R.drawable.gradient_chart_red_bg));
        mFirstStage = true;
  ...
  void calcDates(){
    ...
    getWeightAggregateWeekly(startDate,endDate);
                ...
                public void onNext(Aggregate value) {
                  ...
                  for(int i=0;i<value.getAggregate().getValue().size();i++){
                    ...
                    if(week==value.getAggregate().getValue().get(i).getWeek()+1){
                      WeightGraphDetailActivity.average.setText(value.getAggregate().getValue().get(i).getAverage()+" kilograms");
                    }
                  }
                ...
                for(int i=0;i<weeksinMonth.size();i++){
                    ...
                    if(sum>0.0f) {
                      ...
                      mChart.setXLabels(LabelPosition.OUTSIDE)
                          ...
                          .setValueThreshold((float)userMasterGoal.getGoals().getWeight().getValue(), (float)userMasterGoal.getGoals().getWeight().getValue(), thresPaint).setTooltips(mTip)
