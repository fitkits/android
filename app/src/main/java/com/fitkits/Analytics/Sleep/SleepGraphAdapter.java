...
import com.fitkits.Analytics.Calories.CalorieGraphFragment;
 ...
 * @since 1.0
 */
public class SleepGraphAdapter extends FragmentPagerAdapter {
    Bundle bundle;
    int length;
     ...
     */
    public SleepGraphAdapter(FragmentManager childFragmentManager) {
    ...
    public Fragment getItem(int position) {
        Fragment fragment=new SleepGraphFragment();
