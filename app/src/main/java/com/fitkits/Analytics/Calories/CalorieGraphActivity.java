...
public class CalorieGraphActivity extends AppCompatActivity implements LogCalorieDialog.InterfaceCommunicator,CalorieDialog.InterfaceCommunicator {
  ...
  public static CalorieGraphActivity calorieGraphActivity;

  CustomFixedHeightViewPager calorieDataViewPager;
  TabLayout tabLayout;
  CardView logweight;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    calorieGraphActivity =this;
    myPrefs= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
    mChart = (StackBarChartView)findViewById(R.id.chart_bar);
    setGoal=(ImageView)findViewById(R.id.setGoal);
    calorieDataViewPager =(CustomFixedHeightViewPager)findViewById(R.id.weightDataViewPager);
    target=(TextView)findViewById(R.id.target);
    tabLayout = (TabLayout)findViewById(R.id.tabs);
    tabLayout.setupWithViewPager(calorieDataViewPager);
    ...
    viewMore.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {
        startActivity(new Intent(CalorieGraphActivity.this,CalorieGraphDetailActivity.class));
      }
    });
  ...
  void calcDates(int from){
    ...
    getCalorieAggregate(startDate,endDate,weeksinMonth,from);
        ...
        Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(
          new Observer<ItemParent>() {
            ...
            public void onSubscribe(Disposable d) {
              progressDialog = new ProgressDialog(CalorieGraphActivity.this);
            ...
            public void onNext(ItemParent itemParent) {
              ...
              for (int i = 0; i < value.size(); i++) {
                ...
                if(value.get(i).getType().equals("caloriesPerDay")) {
                  for(int j=0;j<value.size();j++) {
                    if (value.get(j).getType().equals("caloriesPerDay")) {
              ...
              for (int i = 0; i < datesList.size(); i++) {
                Log.d("dlisted",datesList.get(i).getDate()+"-->"+datesList.get(i).getVal());
                ...
                if (i == datesList.size() - 1) {
                  if (datesList.get(i).getVal() != 0) {
                    if (userMasterGoal.getGoals().getCaloriesPerDay().getValue()!=0) {
                      if (datesList.get(i).getVal() > userMasterGoal.getGoals().getCaloriesPerDay().getValue()) {
                ...
                mValuesOne[i] = datesList.get(i).getVal();
              }
              if(sum>0.0f) {
                if (from == 0) {
                  ...
                  mChart.setXLabels(LabelPosition.TOP)
                      ...
                      .setValueThreshold(
                          (float) userMasterGoal.getGoals().getCaloriesPerDay().getValue(),
                          (float) userMasterGoal.getGoals().getCaloriesPerDay().getValue(),
                  ...
                  mChart.setAxisBorderValues(0f,5000f);
              ...
              calorieDataViewPager.setAdapter(
                  new GoalDataViewPagerAdapter(getSupportFragmentManager(), datesList, weeksinMonth,
                      "caloriesPerDay"));
              calorieDataViewPager.setOffscreenPageLimit(weeksinMonth.size());
