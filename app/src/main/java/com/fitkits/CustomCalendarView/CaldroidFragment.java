package com.fitkits.CustomCalendarView;
...
import com.fitkits.Model.Attendance;
...
public class CaldroidFragment extends DialogFragment {
    ...
    TextView attended,totalThisMonth;
    /**
     * Initial params key
     */
    ...
    protected void refreshMonthTitleTextView() {
        ...
        monthTitleTextView.setText(monthTitle.substring(0,1).toUpperCase()+monthTitle.substring(1));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attendanceText=(TextView)view.findViewById(R.id.attendance);
    ...
    protected ArrayList<String> getDaysOfWeek() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            String day=fmt.format(date).toUpperCase();
            list.add(String.valueOf(day.charAt(0)));
    ...
    void getAttendanceAvg() {
        ...
        apiService.getAttendanceAvg("/api/v1/analytics/attendance?type=totalPercentage&status=true&user="+myPrefs.getString("user_id","")).subscribeOn(
            ...
            new Observer<AttAggregate>() {
                ...
                @Override
                public void onNext(AttAggregate value) {
