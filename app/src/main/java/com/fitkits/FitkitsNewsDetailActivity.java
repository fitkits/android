...
public class FitkitsNewsDetailActivity extends AppCompatActivity {
    ...
    apiService.getFeedDetail("/api/v1/cms/feeds/"+blog_id).subscribeOn(
        ...
        new Observer<Feed>() {
          ...
          public void onSubscribe(Disposable d) {
            progressDialog = new ProgressDialog(FitkitsNewsDetailActivity.this);
...
try {
  ...
  content.setVisibility(View.VISIBLE);
          ...
          public void onError(Throwable e) {
            ...
            Toast.makeText(FitkitsNewsDetailActivity.this,"Something went wrong. Please try again later.",Toast.LENGTH_LONG).show();
    ...
    client.newCall(request).enqueue(new Callback() {
      ...
      public void onFailure(Call call, IOException e) {
        Toast.makeText(FitkitsNewsDetailActivity.this,"Something went wrong. Please try again later.",Toast.LENGTH_SHORT).show();
      ...
      public void onResponse(Call call, Response response) throws IOException {
        ...
        try {
          ...
          FitkitsNewsDetailActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
              //Handle UI here
              try {
