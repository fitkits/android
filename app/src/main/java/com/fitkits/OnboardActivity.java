...
import static com.fitkits.fragment_onboard1.flagfemale;
import static com.fitkits.fragment_onboard1.flagmale;
import static com.fitkits.fragment_onboard2.year;
import static com.fitkits.fragment_onboard2.yearList;
import static com.fitkits.fragment_onboard3.feet;
import static com.fitkits.fragment_onboard3.inches;
import static com.fitkits.fragment_onboard4.weight;
import static com.fitkits.fragment_onboard5.flagNonVeg;
import static com.fitkits.fragment_onboard5.flagVeg;
import static com.fitkits.fragment_onboard6.bloodGroupList;
import static com.fitkits.fragment_onboard6.blood_group;
        ...
        apiService.updateProfile("/api/v1/cms/users/"+myPrefs.getString("user_id",""),user_profile).subscribeOn(
            ...
            new Observer<User>() {
              ...
              public void onError(Throwable e) {
                ...
                Toast.makeText(OnboardActivity.this,"Something went wrong. Please try again later.",Toast.LENGTH_LONG).show();
       ...
       /* OkHttpClient client = new OkHttpClient();
        ...
        client.newCall(request).enqueue(new Callback() {
          ...
          public void onFailure(Call call, IOException e) {
            Toast.makeText(OnboardActivity.this,"Something went wrong. Please try again later.",Toast.LENGTH_SHORT).show();
